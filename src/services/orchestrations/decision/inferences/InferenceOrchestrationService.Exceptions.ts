...
import { UsageDependencyException } from "../../../../models/foundations/usages/exceptions/UsageDependencyException.js";
import { UsageDependencyValidationException } from "../../../../models/foundations/usages/exceptions/UsageDependencyValidationException.js";
import { UsageServiceException } from "../../../../models/foundations/usages/exceptions/UsageServiceException.js";
import { UsageValidationException } from "../../../../models/foundations/usages/exceptions/UsageValidationException.js";
...
// never has to know which model was behind the nature it asked for. The categorical wrapper the
...
function isDependencyValidation(error: unknown): error is { innerError: Error } {
  return (
    error instanceof BrainValidationException ||
    error instanceof BrainDependencyValidationException ||
    error instanceof UsageValidationException ||
    error instanceof UsageDependencyValidationException
  );
}

function isDependency(error: unknown): error is { innerError: Error } {
  return (
    error instanceof BrainDependencyException ||
    error instanceof BrainServiceException ||
    error instanceof UsageDependencyException ||
    error instanceof UsageServiceException
  );
}
